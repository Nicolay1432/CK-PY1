...
for v_i in enumerate([2, 90, -2, 8, -36, -44, -1, -85, -14, 90, -22, -90, -100, -8, 38, -92, -45, 67, 53, 25]):
    print("Индекс/Значение",v_i) # индексы/значения
...
list_numbers[9], list_numbers[19] = list_numbers[9], list_numbers[19]
print(list_numbers)
